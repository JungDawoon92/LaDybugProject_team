...
<jsp:include page="/WEB-INF/include/Nav.jsp" />
	...
	<div>
		...
		<h4>${ chef_id } 님의 레시피입니다.
			<c:if test="${ member_id ne chef_id }">
	...
	<c:forEach var="chefsList" items="${ chefRecipeList }" varStatus="status">
		<div class="col-12 col-sm-6 col-lg-4">
			<div class="single-best-receipe-area mb-30">
				<a href='getRecipe.re?recipe_no=${ chefsList.recipe_no }'>
					<img src='${pageContext.request.contextPath}/resources/img/recipe-com-img/${ chefsList.recipe_complete_img }' alt='${ chefsList.recipe_complete_img }' style='width:350px; height:300px;'>
				</a>
