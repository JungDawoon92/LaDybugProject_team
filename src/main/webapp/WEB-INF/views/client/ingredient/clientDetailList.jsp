         ...
         <a href="#" class="">
            ...
            <div class="row">
                <!-- Single Best Receipe Area -->
             	<c:forEach items="${ingredient}" var="list">
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="${pageContext.request.contextPath}/resources/img/ingredient-img/${list.ingredient_thumbName}"
                        	style="width: 350px; height: 263px;" alt="${list.ingredient_nm}" title="${list.ingredient_nm}">
                        <div class="receipe-content">
                            <a href="receipe-post.html">
                                <h5><a href ="clientDetail.do?ingredient_no=${list.ingredient_no}">${list.ingredient_nm}</a></h5>
                                <h6></h6><fmt:formatNumber type="number" maxFractionDigits="3" value="${list.ingredient_price}" />원
