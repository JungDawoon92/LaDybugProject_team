                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="deliciousNav" >
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    <li class="active"><a href="index.html">레시피</a></li>
                                    <li><a href="clientDetailList.do">식재료</a></li>
                                    <li><a href="#">랭크</a></li>
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="top-cta-content">
                            <a href="clientDetailList.do" class="btn delicious-btn" style="border-left-width: 0px;">식재료 더보기</a>
                        </div>
                    </div>
                <!-- Single Best Receipe Area -->
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="single-best-receipe-area mb-30">
                        <img src="<spring:url value='/resources/img/ingredient-img/${ingredient.ingredient_thumbName}'/>">
                        <div class="receipe-content">
                            <a href="receipe-post.html">
                                <h5><a href ="clientDetail.do?ingredient_no=${ingredient.ingredient_no}">${ingredient.ingredient_nm}</a></h5>
                            </a>
                            <div class="ratings">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
