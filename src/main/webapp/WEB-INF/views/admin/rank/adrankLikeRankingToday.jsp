...
<div class="container">
	...
	<div class="pull-right">
		<a href="getRankLikeRankingListToday.rk.ad" class="btn btn-outline-success btn-md active" role="button">일간</a>
	...
	<c:forEach var="toLikeList" items="${ todayLikeList }" varStatus="status">
		<div class="col-12 col-sm-6 col-lg-4">
			<div class="single-best-receipe-area mb-30">
				<a href='getTestRecipe.re.ad?recipe_no=${toLikeList.recipe_no}'>
