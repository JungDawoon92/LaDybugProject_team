...
function dayCheck(date, title) {
	...
	if(targetDate == null) {
		...
		targetTitle = year + "년 " + month + "월 " + date +"일 TOP10 쉐프";
	}
	...
	$("#subDayChartTable").empty();
	
	$.ajax({
		url: "getDayTopChefChart.rk.ad",
		type: "POST",
		data: day_params,
		dataType: "JSON",
...
$(function() {	
	...
	.on("changeDate", function() {
		...
		var month = arr[1];
		var day = arr[2];
		var title = year + "년 " + month + "월 " + day +"일 TOP10 쉐프";
		dayCheck(date, title);
	});
});//ready end
