...
<jsp:include page="/WEB-INF/include/adminNav.jsp" />
	...
	<table class="table table-hover">
		...
		<tbody id="sellRecipeMonthChartTable">
...
function monthCheck(date, title) {
	...
	if(targetDate == null) {
		...
		targetTitle = year + "년 " + month + "월 TOP10 레시피";
	}
	...
	$("#sellRecipeMonthChartTable").empty();
	
	$.ajax({
		url: "getMonthTopSellRecipeChart.rk.ad",
		type: "POST",
		data: mt_params,
		dataType: "JSON",
		success: function(result) {
			$.each(result, function(index, value){
				...
				$("#sellRecipeMonthChartTable").append(row);
			});	
...
$(function() {	
	...
	.on("changeDate", function() {
		...
		var month = arr[1];
		var day = arr[2];
		var title = year + "년 " + month + "월 TOP10 레시피";
