...
<jsp:include page="/WEB-INF/include/adminNav.jsp" />
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="nav-item dropdown">
			<a class="nav-link dropdown-toggle active" href="#" id="navbardrop" data-toggle="dropdown">레시피 차트</a>
			<div class="dropdown-menu">
	...
	<br>
	<h1>이용후기 TOP10 레시피 차트</h1>
	<div>
		<canvas id="commentCanvas" style="height:30vw; width:50vw; margin:auto"></canvas>
	</div>
	<br><br>
...
var commentChartLabels = [];
var commentChartData = [];


$.ajax({
	url : "getCommentTopChart.rk.ad",
	type : "POST",
	dataType : "JSON",
	success : function(result) {
		$.each(result, function(index, value) {
			commentChartLabels.push(value.recipe_nm);
			commentChartData.push(value.comment_count);
