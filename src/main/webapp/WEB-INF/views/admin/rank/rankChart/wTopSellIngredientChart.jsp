...
function weekCheck(date, title) {
	...
	if(targetDate == null) {
		...
		targetTitle = year + "년 " + month + "월 " + date +"일이 속한 주의 TOP10 식재료";
	}
	...
	$("#ingreWeekChartTable").empty();
	
	$.ajax({
		url: "getWeekTopIngredientChart.rk.ad",
		type: "POST",
		data : we_params,
		dataType : "JSON",
		success : function(result) {
			$.each(result, function(index, value) {
				...
				$("#ingreWeekChartTable").append(row);
			});
...
$(function() {	
	...
	.on("changeDate", function() {
		...
		var month = arr[1];
		var day = arr[2];
		var title = year + "년 " + month + "월 " + day +"일이 속한 주의 TOP10 식재료";
