...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "zn1UwLOJtD_rnx8QMNPp";
	private final static String CLIENT_SECRET = "SmqN3cJ3Z9";
	private final static String REDIRECT_URI = "http://localhost:8090/shepe/callback";
