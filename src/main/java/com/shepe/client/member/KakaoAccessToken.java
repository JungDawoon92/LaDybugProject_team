...
public class KakaoAccessToken {
	private final static String K_CLIENT_ID = "c6a49983fb5ff7fab52b254f99466435";
	// 이런식으로 REDIRECT_URI를 써넣는다. // //
	private final static String K_REDIRECT_URI = "http://localhost:8090/shepe/kakaoLogin";
